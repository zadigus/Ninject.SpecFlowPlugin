...
so that I can access them.
    ...
    Scenario Outline: Injected transient scenario dependencies are different in all scenarios

        Given I have injected TransientScenarioDependency in the binding class StepClass1
        Then the property MyProp of TransientScenarioDependency has no value in StepClass1
        When I set property MyProp of TransientScenarioDependency to value '<value>' in StepClass1
    ...
    Scenario Outline: Injected singleton scenario dependencies are different in all scenarios

        Given I have injected SingletonScenarioDependency in the binding class StepClass1
        Then the property MyProp of SingletonScenarioDependency has no value in StepClass1
        When I set property MyProp of SingletonScenarioDependency to value '<value>' in StepClass1
