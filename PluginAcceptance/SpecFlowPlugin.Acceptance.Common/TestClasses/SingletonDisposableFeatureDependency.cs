namespace SpecFlowPlugin.Acceptance.Common.TestClasses
{
    ...
    public sealed class SingletonDisposableFeatureDependency : ISingletonDisposableFeatureDependency
    {
        private readonly TestThreadContext testThreadContext;

        public SingletonDisposableFeatureDependency(TestThreadContext testThreadContext)
        {
