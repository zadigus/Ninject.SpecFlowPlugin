namespace SpecFlowPlugin.Acceptance.Common.TestClasses
{
    ...
    public sealed class SingletonDisposableScenarioDependency : ISingletonDisposableScenarioDependency
    {
        private readonly FeatureContext featureContext;

        public SingletonDisposableScenarioDependency(FeatureContext featureContext)
        {
